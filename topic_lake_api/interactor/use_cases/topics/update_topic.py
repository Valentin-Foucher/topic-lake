...
class UpdateTopic(UseCase):
    ...
    async def execute(self, user_id: int, topic_id: int, parent_topic_id: Optional[int], content: str):
        ...
        return await self._topics_repository.update(user_id, topic_id, parent_topic_id, content)
